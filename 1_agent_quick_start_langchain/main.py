...
def get_cordinates(city_name: str, country_name: str) -> str:
    """"Tool responsible to get the latitude and longitude of a location"""
    url = f"http://api.openweathermap.org/geo/1.0/direct?q={city_name},{country_name}&limit=5&appid={weather_cordinates_api_key}"
    response = get(url)
